...
export const getAllEnquiries = async(req: Request, res: Response) => {
    try {
        ...
        const maidWhereClause: any = {};
        const employerWhereClause: any = {};
        ...
        if (search) {
            const searchCondition = {
                OR: [
                    ...
                    { mobile_number: { contains: search as string, mode: 'insensitive' } },
                    { wp_number: { contains: search as string, mode: 'insensitive' } },
        ...
        if (search) {
            const searchCondition = {
                OR: [
                    { full_name: { contains: search as string, mode: 'insensitive' } },
                    { contact_number: { contains: search as string, mode: 'insensitive' } },
...
export const changeEnquiryStatus = async(req:Request,res:Response) => {
    try {
        const { id } = req.params;

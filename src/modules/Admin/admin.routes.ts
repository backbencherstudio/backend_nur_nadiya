...
import { editEnquiry } from "./add-enquiries/add_enquiries.controller.js"
...
adminRoute.patch("/edit-enquiry/:id", verifyAdmin, upload.single('image'), handleUploadError, editEnquiry)
